    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            //TODO: Create a method that will set numbers that are a multiple of 3 to
            //zero then print to the console all numbers   ---DONE
            ...
            //you will need a method for this ---DONE           
            Populater(numList);
            ...
            //TODO: Create a method that will remove all odd numbers
            //from the list then print results ---DONE
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes, we have {searchNumber} in our list");
            }
            else
            {
                Console.WriteLine($"No, we do not have {searchNumber} in our list");
            }
        }
